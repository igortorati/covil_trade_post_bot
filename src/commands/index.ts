...
export const commands: Record<string, Command> = {
  ...
  [STRING_COMMANDS.LIST_TRADABLE_ITEM_FROM_CURRENT_SEASON] : new ListTradableItemsOnCurrentSeasonCommand(),
  [STRING_COMMANDS.LIST_PURCHASABLE_ITEM_FROM_CURRENT_SEASON] : new ListPurchasableItemsOnCurrentSeasonCommand(),
